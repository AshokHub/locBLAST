...
<body>
	<div class="output">
		...
		<h4 style="text-align:center; color:blue" id="top">DELTA-BLAST Program Description</h4>
<pre>
USAGE
...
DESCRIPTION
   Domain enhanced lookup time accelarated BLAST 2.5.0+
 ...
 *** Miscellaneous options
 ...
 -remote
   ...
   num_threads, num_iterations, show_domain_hits
 -use_sw_tback
